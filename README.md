...
### Tip: hiding the overlay with a key

Crabwise deliberately does not register a keyboard shortcut of its own, because a
system-wide hotkey can collide with a League keybind. **OBS already does this better** — it
hides the source without Crabwise needing to know:

**Settings → Hotkeys**, find your Crabwise browser source in the list, and set a key for
**Hide** and **Show**.
